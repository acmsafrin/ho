...
import gov.sp.health.autobean.InstitutionFacade;
...
public class InstitutionController implements Serializable {
    ...
    @EJB
    private gov.sp.health.autobean.InstitutionFacade ejbFacade;
    ...
    public static class InstitutionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Institution) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + InstitutionController.class.getName());
            }
        }
    }
}
