...
public final class DesignationController {
    ...
    public List<Designation> getAreas() {
        lstItems =  (getFacade().findBySQL("Select d From Designation d"));
        return lstItems;
    }

    public void setAreas(List<Designation> areas) {
        this.lstItems = areas;
    }
    ...
    public DataModel getItems() {
        if (items == null) {
            items = new ListDataModel(getFacade().findBySQL("Select d From Designation d"));
